...
#define MU_TYPE_HEADER MuonType as_type

/// A core type
typedef struct {
  MU_TYPE_HEADER;
  const mu_core_t *core;
  const MuonType *argv[/* core->argc */];
} mu_core_type_t;
 ...
 *
 * @a abstract should have type <tt>const MuonType *</tt>. @a concrete should
 ...
 * - @a abstract doesn't have type <tt>const MuonType *</tt>
...
#define mu_type_cast(abstract, concrete) __extension__ ({ \
  const MuonType *_abstract = (abstract); \
