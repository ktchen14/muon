...
#define MUON_EMIT(T, l, UPPER, Ts, ls, US) MUON_##UPPER##_##US,
  ...
  MUON_MINORANT_STATOR =
      MUON_INDIRECT(MUON_TAKE, MUON_EACH_STATOR_STEM(MUON_EMIT, , , STATOR)),

  /// Equivalent to the maximum enumerator in MuonNodeEnumerator
  MUON_MINORANT_NODE_STATOR =
      MUON_INDIRECT(MUON_TAKE, MUON_EACH_NODE_STEM(MUON_EMIT, , , STATOR)),

  /// Equivalent to the minimum enumerator in MuonExprEnumerator
  MUON_MINORANT_EXPR_STATOR =
      MUON_INDIRECT(MUON_TAKE, MUON_EACH_EXPR_STEM(MUON_EMIT, , , EXPR_STATOR)),

  /// Equivalent to the minimum enumerator in MuonSignEnumerator
  MUON_MINORANT_SIGN_STATOR =
      MUON_INDIRECT(MUON_TAKE, MUON_EACH_SIGN_STEM(MUON_EMIT, , , SIGN_STATOR)),

  /// Equivalent to the minimum enumerator in MuonStmtEnumerator
  MUON_MINORANT_STMT_STATOR =
      MUON_INDIRECT(MUON_TAKE, MUON_EACH_STMT_STEM(MUON_EMIT, , , STMT_STATOR)),

  /// Equivalent to the minimum enumerator in MuonStmtEnumerator
  MUON_MINORANT_VIEW_STATOR =
      MUON_INDIRECT(MUON_TAKE, MUON_EACH_VIEW_STEM(MUON_EMIT, , , VIEW_STATOR)),
#undef MUON_EMIT
#undef MUON_TAKE
#undef MUON_INDIRECT
